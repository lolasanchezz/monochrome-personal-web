...
const MiddleInfo: React.FC<any> = ({infoClicked}) => {
     ...
     if (infoClicked === "about") {
        ...
        <div className = {styles.projCont}>
          ...
          <p>{"a website that graphs the entirety of the sec's data through the sec's edgar api. extremely difficult in terms of sorting through the sec's messy json, from null labels to inconsistent data,but ultimately very rewarding! completed with react, next.js, node.js, and express.js. available at graphthesec.xyz"}</p>
        </div>
        )
        ...
        return (
          <div className = {styles.text}>
            ...
            <p>{"i am currently a rising high schooler at grace church high school in NYC. while most of my web development skills are self-taught, i took computer science I with my school, experimental economics at uchicago's summer program, cybersecurity at gw's summer program,  a course in NLP machine learning with inspirit ai and a introductory swift course with kode with klossy."}
            </p>
          </div>
        )
